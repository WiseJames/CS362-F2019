...
void baronCardEffect(struct gameState *state, int choice1, int currentPlayer) {
...
void minionCardEffect(struct gameState* state, int handPos, int currentPlayer, int choice1, int choice2) {
	//+1 action
	state->numActions++;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
	...
	case baron:
		baronCardEffect(state, choice1, currentPlayer);
		return 0;
	...
	case tribute:
		tributeCardEffect(state, nextPlayer, tributeRevealedCards, currentPlayer);
		return 0;
